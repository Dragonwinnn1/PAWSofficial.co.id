...
const PRODUCTS = [
  { id: "p1", name: "SKATEGRAFFITI WHITE", price: 150000, images: ["https://github.com/Dragonwinnn1/PAWSofficial.co.id/blob/main/BAJU1.jpg?raw=true"], category: ["kaos","new-drop"], description: "Cotton Combed 30s. Regular Fit.", variants: { S: 10, M: 10, L: 10, XL: 10 } },
  { id: "p2", name: "SKATEGRAFFITI BLACK", price: 150000, images: ["https://github.com/Dragonwinnn1/PAWSofficial.co.id/blob/main/BAJU2.jpg?raw=true"], category: ["jaket","sale"], description: "Fleece 280gsm. Oversize Fit.", variants: { S: 10, M: 10, L: 10, XL: 10 } },
